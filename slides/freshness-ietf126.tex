...
\subtitle{draft-ietf-lamps-attestation-freshness}
...
\begin{frame}{Changes from -05 to -08}
  ...
  \vspace{0.25cm}
  \begin{block}{Scope}
    Request a nonce before enrollment. Then, include it inside the
    ...
    \begin{column}{0.52\textwidth}
      \begin{tikzpicture}[
        ...
        \node[font=\scriptsize,align=center,below=.3cm of b]
          {Conceptual Message Wrapper (CMW) combines\\the individual Evidence statements};
      \end{tikzpicture}
    \end{column}
...
\begin{frame}[fragile]{TPM 2.0 Example with JSON for EST over HTTP}
  \begin{columns}[T,onlytextwidth]
...
\end{lstlisting}
  ...
  Informative example only; the OIDs are placeholders and no TPM profile is defined.\par}
\end{frame}
...
\begin{frame}{Summary and next steps}
  ...
  \begin{itemize}
    ...
    \item open-source implementation:
          \href{https://github.com/Guiliano99/RAT-E2E}{\texttt{https://github.com/Guiliano99/RAT-E2E}}.
  \end{itemize}
