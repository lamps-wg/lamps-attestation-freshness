  ...
  \begin{columns}[T,onlytextwidth]
      ...
      \begin{block}{Nonce-based freshness}
        \begin{itemize}
          ...
          \item A match proves that the Evidence was produced after the
                challenge; the Attester needs no synchronized clock.
    ...
    \begin{column}{0.47\textwidth}
      \begin{block}{Freshness data in Claims}
        \begin{itemize}
          \setlength{\itemsep}{2pt}
          \item The Attester has no clock and therefore cannot add collection
                timestamps to the Claims.
          \item When the Claim values were collected is therefore unknown.
          \item Claim values may have changed between their collection and the
                production of the Evidence.
          \item Fresh Evidence does not by itself prove that individual Claim
